...
from deeploglizer.common.dataloader_lb import load_sessions_lb, log_dataset
...
if __name__ == "__main__":
    ...
    session_train, session_test = load_sessions_lb(data_dir=params["data_dir"], test_file=params["test_file"])
