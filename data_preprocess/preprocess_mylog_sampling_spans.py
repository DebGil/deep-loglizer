...
data_name = f'mylog_sampled_{params["train_anomaly_ratio"]}_span_tar'
data_dir = "../data/processed/mylog_100k"

params = {
    "log_file": "../data/mylog/raw_log-F0306.log_structured_sorted.csv",
    "label_file": "../data/mylog/ERROR_SpanData-F0306.csv",
    "test_ratio": 0.8,
...
def preprocess_mylog(
    ...
    **kwargs
    ...
    templates_to_drop = int(0.05 * total_templates)
