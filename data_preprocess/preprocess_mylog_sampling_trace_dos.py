...
params = {
   # "log_file": "../data/mylog/normal0726data-raw_log_small.log_structured_sorted_even.csv",
    #"label_file": "../data/mylog/normal0726data-SUCCESS_SpanData_smaller_even.csv",
...
def preprocess_mylog(
    ...
    **kwargs
    ...
    for session_id, index_to_drop in sorted(templates_indices_to_drop, key=lambda x: x[1], reverse=True):
